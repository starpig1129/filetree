              ...
              {files?.map((file, idx) => {
                ...
                return (
                  <motion.div
                    ...
                    className={cn(
                      "relative group flex items-center gap-4 p-3 bg-white/40 dark:bg-white/5 hover:bg-white/80 dark:hover:bg-white/10 border border-transparent hover:border-cyan-500/30 rounded-xl transition-all duration-300 cursor-pointer shadow-sm hover:shadow-md",
                      isSelected && "ring-2 ring-cyan-500 bg-cyan-50 dark:bg-cyan-900/10",
                      isLocked && "opacity-75"
                    )}
                  >
                    ...
                    <div className="flex items-center gap-1 shrink-0 opacity-100 lg:opacity-0 lg:group-hover:opacity-100 transition-opacity">
                      ...
                      {isAuthenticated && (
                        <button
                          onClick={(e) => { e.stopPropagation(); onDelete(file.name); }}
                          className="p-1.5 hover:bg-red-50 dark:hover:bg-red-500/10 rounded-lg text-red-400 hover:text-red-500 transition-colors"
                          title="Delete"
                        >
                      ...
                      <button
                        ...
                        className="lg:hidden p-1.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200"
                      >
                        <MoreVertical className="w-4 h-4" />
                      </button>
                    </div>
